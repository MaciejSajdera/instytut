<?php
/**
 * Template Name: doradztwo i szkolenia
 *
...
<div class="section-container workshops">
	<div class="container-fluid px-0">
		...
		<div class="workshop-section <?php
					if ($count % 2 == 0):
						if (get_queried_object_id() == $bizWrokshopsID):
							echo "bg-black";
						else:
						    echo 'bg-abstract-black'; endif;
					else:
						if (get_queried_object_id() == $bizWrokshopsID):
							echo "bg-green";
							else:
							echo 'bg-abstract-green'; endif;
					endif;
					?>">
			<div class="row my-container">
				...
				<div class="col-md-6 read-more-container">
					<a class="<?php
					if ($count % 2 == 0):
					echo "my-read-more-button-green-bg-black";
					else:
				...
				<div class="col-md-6 only-on-md-and-up mt-3">
					<a href="mailto:sekretariat@impib.pl" class="<?php
					if ($count % 2 == 0):
					echo "green-button";
					else:
					echo "black-button-radius";
					endif;
					?>"><?php echo the_field('join', 609) ?></a>
				</div>
				<div class="col-12">
